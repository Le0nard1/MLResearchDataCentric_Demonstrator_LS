...
def main():
    ...
    ap.add_argument("--stage", choices=["pilot", "smoke", "tune", "tune_pilot", "tune_smoke", "main", "main_a1", "bench", "bench_smoke",
                             "main_smoke"],
                    required=True)
    ...
    worker, cols, keys = ((_safe_tune, TUNE_COLS, ["dataset", "region", "noise", "seed",
                          ...
                          if tune else (_safe, COLS, ["dataset", "region", "noise",
                                                      "seed"]))
    if a.stage in ("main", "main_smoke", "main_a1", "bench", "bench_smoke"):
    ...
    if a.stage in ("main", "main_smoke", "main_a1", "bench", "bench_smoke"):
        ...
        FIXED.update(main=True, tuned=json.loads(TUNED_FILE.read_text()),
                     ...
                     bench=a.stage.startswith("bench"))
